...
add wave -noupdate -expand -group {Standard WB} -color White -expand -subitemconfig {/top/SVA/CLK {-color White} /top/SVA/issue_dest_PR {-color White} /top/SVA/WB_PR {-color White} /top/SVA/inv_issue_valid {-color White} /top/SVA/inv_WB_ready {-color White} /top/SVA/inv_nRST {-color White}} /top/SVA/a_tc_standard_WB_PR
add wave -noupdate -expand -group {Standard WB} -color White -expand -subitemconfig {/top/SVA/CLK {-color White} /top/SVA/issue_ROB_index {-color White} /top/SVA/WB_ROB_index {-color White} /top/SVA/inv_issue_valid {-color White} /top/SVA/inv_WB_ready {-color White} /top/SVA/inv_nRST {-color White}} /top/SVA/a_tc_standard_WB_ROB_index
