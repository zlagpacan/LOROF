/*
    Filename: bram_1xdelay_1rport_1wport_wrapper.sv
    Author: zlagpacan
    Description: RTL wrapper around bram_1xdelay_1rport_1wport module. 
...
module bram_1xdelay_1rport_1wport_wrapper #(
	...
	input logic next_ren0,
	input logic next_ren1,
