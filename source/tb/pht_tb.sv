...
module pht_tb #(
    ...
    // read resp stage
	corep::fetch_lane_t [1:0] tb_read_resp_redirect_lane_by_way;

	logic [1:0] DUT_read_resp_taken_by_way, expected_read_resp_taken_by_way;
	...
	pht #(
	    ...
	    // read resp stage
		.read_resp_redirect_lane_by_way(tb_read_resp_redirect_lane_by_way),

		.read_resp_taken_by_way(DUT_read_resp_taken_by_way),
    ...
    task check_outputs();
    begin
		if (expected_read_resp_taken_by_way[0] !== DUT_read_resp_taken_by_way[0]) begin
			$display("TB ERROR: expected_read_resp_taken_by_way[0] (%h) != DUT_read_resp_taken_by_way[0] (%h)",
				expected_read_resp_taken_by_way[0], DUT_read_resp_taken_by_way[0]);
			num_errors++;
			tb_error = 1'b1;
		end

		if (expected_read_resp_taken_by_way[1] !== DUT_read_resp_taken_by_way[1]) begin
			$display("TB ERROR: expected_read_resp_taken_by_way[1] (%h) != DUT_read_resp_taken_by_way[1] (%h)",
				expected_read_resp_taken_by_way[1], DUT_read_resp_taken_by_way[1]);
			num_errors++;
			tb_error = 1'b1;
		end
    ...
    initial begin
	    ...
	    // read resp stage
		tb_read_resp_redirect_lane_by_way[0] = 3'h0;
		tb_read_resp_redirect_lane_by_way[1] = 3'h0;
	    // update
	    ...
	    // read req stage
	    // read resp stage
		expected_read_resp_taken_by_way[0] = 1'b0;
		expected_read_resp_taken_by_way[1] = 1'b0;
	    // update
        ...
        // read resp stage
		tb_read_resp_redirect_lane_by_way[0] = 3'h0;
		tb_read_resp_redirect_lane_by_way[1] = 3'h7;
        // update
        tb_update_valid = 1'b0;
        tb_update_pc38 = {26'h0000000, 9'h000, 3'h0};
        tb_update_gh = {2'h0, 9'h000, 3'h0};
		...
		tb_read_req_asid = 16'hffff;
        // read resp stage
		tb_read_resp_redirect_lane_by_way[0] = 3'b010;
		tb_read_resp_redirect_lane_by_way[1] = 3'b101;
        // update
        tb_update_valid = 1'b0;
        tb_update_pc38 = {26'h0000000, 9'h000, 3'h0};
        tb_update_gh = {2'h0, 9'h000, 3'h0};
        ...
        // read req stage
        // read resp stage
        expected_read_resp_taken_by_way[0] = 1'b1;
        expected_read_resp_taken_by_way[1] = 1'b0;
        // update
